...
from companyBlog import db, mail
...
def account():
    ...
    return render_template('account.html.j2', profile_image=profile_image, form=form, email=current_user.email)
...
def user_posts(username):
    ...
    profile_image = url_for('static', filename='profile_pics/' + current_user.profile_image)
    return render_template('user_blog_posts.html.j2',blog_posts=blog_posts,user=user,profile_image=profile_image)

def send_reset_email(user):
    token = user.get_reset_token()
    msg = Message('Password Reset Request',
                  sender='noreplytechiejr@gmail.com',
